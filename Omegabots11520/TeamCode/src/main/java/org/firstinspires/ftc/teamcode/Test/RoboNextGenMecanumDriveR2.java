...
//@TeleOp(name="RoboNextGenMecanumDriveR2", group="RoboNextGen Opmode") // @Autonomous(...) is the other common choice
//@Disabled
public class RoboNextGenMecanumDriveR2 extends LinearOpMode {
    ...
    double motorSpeedForLinearSlide = 0.2;// LINEAR SLIDE SPEED WHEN LOWERING
...
//                robot.linearSlide.setTargetPosition(Floor);
                    ...
                    robot.linearSlide.setPower(0.25);
//                    robot.linearSlide.setMode(DcMotor.RunMode.RUN_TO_POSITION);
//                robot.linearSlide.setPower(0.0);
